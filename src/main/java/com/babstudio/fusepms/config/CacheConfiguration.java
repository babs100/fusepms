package com.babstudio.fusepms.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("FusePMS");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("FusePMS");
        ...
        config.getMapConfigs().put("com.babstudio.fusepms.domain.*", initializeDomainMapConfig(jHipsterProperties));
